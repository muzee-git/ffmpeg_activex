...
// Qing's Patch
mmsx_t *mmsx_connect (mms_io_t *io, void *data, const char *url, const char *host, const char *uri, const  char *query, int pport, int bandwidth)
//mmsx_t *mmsx_connect(mms_io_t *io, void *data, const char *url, int bandwidth)
{
  ...
  mmsx->connection = mms_connect(io, data, url, host, uri, query, pport, bandwidth);
  if (mmsx->connection)
    return mmsx;
    
  mmsx->connection_h = mmsh_connect(io, data, url, host, uri, query, pport, bandwidth);
